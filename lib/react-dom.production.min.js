...
(function(Y, cb) {
  "object" === typeof exports && "undefined" !== typeof module
    ? (module.exports = cb(require("react")))
    : "function" === typeof define && define.amd
    ? define(["react"], cb)
    : (Y.ReactDOM = cb(Y.React));
})(window, function(Y) {
  ...
  function jb(a) {
    var b = a;
    if (a.alternate) for (; b.returnn; ) b = b.returnn;
    else {
      if (0 !== (b.effectTag & 2)) return 1;
      for (; b.returnn; )
        if (((b = b.returnn), 0 !== (b.effectTag & 2))) return 1;
    }
    return 3 === b.tag ? 2 : 3;
  }
  function Ne(a) {
  ...
  function fh(a) {
    ...
    for (var c = a, d = b; ; ) {
      ...
      if (c.returnn !== d.returnn) (c = e), (d = f);
      else {
        g = !1;
        for (var h = e.child; h; ) {
          if (h === c) {
  ...
  function Oe(a) {
    ...
    for (var b = a; ; ) {
      ...
      if (b.child) (b.child.returnn = b), (b = b.child);
      else {
        if (b === a) break;
        for (; !b.sibling; ) {
          if (!b.returnn || b.returnn === a) return null;
          b = b.returnn;
        }
        b.sibling.returnn = b.returnn;
        b = b.sibling;
      }
    }
    return null;
  ...
  function lh(a, b, c, d) {
    this.tag = a;
    this.key = c;
    this.sibling = this.child = this.returnn = this.stateNode = this.type = this.elementType = null;
    this.index = 0;
    this.ref = null;
    this.pendingProps = b;
    ...
    switch (a._status) {
      ...
      default:
        ...
        b.then(
          function(b) {
            0 === a._status &&
              ((b = b.defaultt), (a._status = 1), (a._result = b));
          },
          function(b) {
  ...
  function Cf(a) {
    ...
    function h(a, b, c, d) {
      if (null === b || 6 !== b.tag)
        return (b = td(c, a.mode, d)), (b.returnn = a), b;
      b = e(b, c, d);
      b.returnn = a;
      return b;
    }
    function k(a, b, c, d) {
      if (null !== b && b.elementType === c.type)
        return (d = e(b, c.props, d)), (d.ref = ub(a, b, c)), (d.returnn = a), d;
    ...
    function l(a, b, c, d) {
      if (
        ...
        return (b = ud(c, a.mode, d)), (b.returnn = a), b;
      b = e(b, c.children || [], d);
      b.returnn = a;
      return b;
    }
    function m(a, b, c, d, f) {
      if (null === b || 7 !== b.tag)
        return (b = oa(c, a.mode, d, f)), (b.returnn = a), b;
      b = e(b, c, d);
      b.returnn = a;
      return b;
    }
    function n(a, b, c) {
      if ("string" === typeof b || "number" === typeof b)
        return (b = td("" + b, a.mode, c)), (b.returnn = a), b;
      if ("object" === typeof b && null !== b) {
        switch (b.$$typeof) {
          ...
          case La:
            return (b = ud(b, a.mode, c)), (b.returnn = a), b;
        }
        if (oc(b) || fb(b))
          return (b = oa(b, a.mode, c, null)), (b.returnn = a), b;
        mc(a, b);
      }
      return null;
    }
    ...
    function v(e, g, h, k) {
      ...
      for (m = d(e, m); r < h.length; r++)
        if ((q = z(m, e, r, h[r], k)))
          a && null !== q.alternate && m.deletee(null === q.key ? r : q.key),
            (g = f(q, g, r)),
    ...
    function B(e, g, h, k) {
      ...
      for (r = d(e, r); !A.done; t++, A = h.next())
        (A = z(r, e, t, A.value, k)),
          null !== A &&
            (a && null !== A.alternate && r.deletee(null === A.key ? t : A.key),
            (g = f(A, g, t)),
            null === m ? (l = A) : (m.sibling = A),
            (m = A));
      a &&
    ...
    return function(a, d, f, h) {
      ...
      if ("string" === typeof f || "number" === typeof f)
        return (
          (f = "" + f),
          null !== d && 6 === d.tag
            ? (c(a, d.sibling), (d = e(d, f, h)), (d.returnn = a), (a = d))
            : (c(a, d), (d = td(f, a.mode, h)), (d.returnn = a), (a = d)),
          g(a)
        );
  ...
  function Hf(a) {
    for (a = a.returnn; null !== a && 5 !== a.tag && 3 !== a.tag; ) a = a.returnn;
    da = a;
  }
  function Bd(a) {
    if (a !== da) return !1;
  ...
  function Aa(a, b, c) {
    ...
    if (null !== b.child) {
      ...
      b.child = c;
      for (c.returnn = b; null !== a.sibling; )
        (a = a.sibling),
        ...
        a: {
          ...
          if (null !== g) {
            ...
            if (0 === f) {
              ...
              for (g = b.child, null !== g && (g.returnn = b); null !== g; ) {
  ...
  function Uf(a) {
    ...
    a: b: for (c = a; ; ) {
      for (; null === c.sibling; ) {
        if (null === c.returnn || Tf(c.returnn)) {
          c = null;
          break a;
        }
        c = c.returnn;
      }
      c.sibling.returnn = c.returnn;
      for (c = c.sibling; 5 !== c.tag && 6 !== c.tag; ) {
        if (c.effectTag & 2) continue b;
        if (null === c.child || 4 === c.tag) continue b;
        else (c.child.returnn = c), (c = c.child);
      }
      if (!(c.effectTag & 2)) {
        c = c.stateNode;
        break a;
    ...
    for (var e = a; ; ) {
      ...
      if (e === a) break;
      for (; null === e.sibling; ) {
        if (null === e.returnn || e.returnn === a) return;
        e = e.returnn;
      }
      e.sibling.returnn = e.returnn;
      e = e.sibling;
    }
  }
  function Sf(a) {
    for (var b = a, c = !1, d = void 0, e = void 0; ; ) {
      ...
      if (5 === b.tag || 6 === b.tag) {
        a: for (var f = b, g = f; ; )
          if ((Rf(g), null !== g.child && 4 !== g.tag))
            (g.child.returnn = g), (g = g.child);
          else {
            if (g === f) break;
            for (; null === g.sibling; ) {
              if (null === g.returnn || g.returnn === f) break a;
              g = g.returnn;
            }
            g.sibling.returnn = g.returnn;
            g = g.sibling;
          }
        e
          ? ((f = d),
      ...
      if (b === a) break;
      for (; null === b.sibling; ) {
        if (null === b.returnn || b.returnn === a) return;
        b = b.returnn;
        4 === b.tag && (c = !1);
      }
      b.sibling.returnn = b.returnn;
      ...
      case 13:
        ...
        if (null !== a)
          a: for (b = c = a; ; ) {
            ...
            if (b === c) break a;
            for (; null === b.sibling; ) {
              if (null === b.returnn || b.returnn === c) break a;
              b = b.returnn;
            }
            b.sibling.returnn = b.returnn;
            b = b.sibling;
          ...
          switch (w & 14) {
            ...
            case 8:
              (G = n),
                ...
                (G.child = null),
                G.alternate &&
                  ((G.alternate.child = null), (G.alternate.returnn = null));
          }
          n = n.nextEffect;
        }
      } catch ($a) {
  ...
  var Eh = ja && "TextEvent" in window && !Eb,
    ...
    Sg = /^(.*)[\\\/]/,
    Q = "function" === typeof Symbol && Symbol.forr,
    nc = Q ? Symbol.forr("react.element") : 60103,
    La = Q ? Symbol.forr("react.portal") : 60106,
    la = Q ? Symbol.forr("react.fragment") : 60107,
    Tc = Q ? Symbol.forr("react.strict_mode") : 60108,
    Ub = Q ? Symbol.forr("react.profiler") : 60114,
    Ae = Q ? Symbol.forr("react.provider") : 60109,
    ze = Q ? Symbol.forr("react.context") : 60110,
    Sc = Q ? Symbol.forr("react.concurrent_mode") : 60111,
    Vc = Q ? Symbol.forr("react.forward_ref") : 60112,
    Uc = Q ? Symbol.forr("react.suspense") : 60113,
    Wc = Q ? Symbol.forr("react.memo") : 60115,
    Be = Q ? Symbol.forr("react.lazy") : 60116,
  ...
  cg = function(a, b, c, d) {
    for (c = b.child; null !== c; ) {
      ...
      if (c === b) break;
      for (; null === c.sibling; ) {
        if (null === c.returnn || c.returnn === b) return;
        c = c.returnn;
      }
      c.sibling.returnn = c.returnn;
      c = c.sibling;
