...
external js_nullable_to_ojs : 'value js_nullable -> Ojs.t = "%identity"

let js_nullable_of_js _f x = js_nullable_of_ojs x

let js_nullable_to_js _f x = js_nullable_to_ojs x

type ('props, 'return) componentLike = 'props -> 'return

type 'props component = ('props, element) componentLike

external component_of_ojs : Ojs.t -> 'props component = "%identity"

external component_to_ojs : 'props component -> Ojs.t = "%identity"

let component_of_js _f x = component_of_ojs x

let component_to_js _f x = component_to_ojs x
